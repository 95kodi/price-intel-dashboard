  ...
  ({ className, variant = "default", size = "md", loading, disabled, children, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center gap-2 font-medium rounded-lg border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed",
          {
            "bg-white border-gray-200 text-gray-700 hover:bg-gray-50 active:scale-[0.98]": variant === "default",
            "bg-blue-600 border-blue-600 text-white hover:bg-blue-700 active:scale-[0.98]": variant === "primary",
